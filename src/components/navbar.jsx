  ...
  return (
    <div className="absolute top-0 left-0 w-full z-10">
      <div className="container mx-auto flex justify-between items-center py-4 px-6 md:px-20 lg:px-32">
        ...
        <div className={`md:hidden ${showMobileMenu ? 'fixed w-full' : 'h-0 w-0'} : 'h-0  w-0'}  right-0 top-0 bottom-0 overflow-hidden bg-white transition-all`}>
          ...
          <a onClick={()=> setShowMobileMenu(false)} href="#About" className='px-4 py2 rounded-full inline-block'>Block</a>
